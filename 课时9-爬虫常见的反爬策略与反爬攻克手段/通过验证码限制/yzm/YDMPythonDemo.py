...
appId = 2957   # 软件ＩＤ，开发者分成必要参数。登录开发者后台【我的软件】获得！
appKey = '5634ea89ff1717dfa14378f3c0fe76f8'     # 软件密钥，开发者分成必要参数。登录开发者后台【我的软件】获得！
...
# 验证码文件路径
filename = 'D:/我的教学/Python/天善智能-爬虫/12/douban123/yanzhengma/captcha.png'
